...
#A nested menu effect can be created by having some buttons open new menus.
#This program lets you choose an option from a nested menu that cascades across
#the screen. You may return to previous menus by pressing ESC.
